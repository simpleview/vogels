...
var deserialize = internals.deserialize = {
...
internals.deserializeAttribute = function (value, type) {
  if(_.isObject(value) && _.isFunction(value.detectType) && _.isArray(value.values)) {
    ...
    switch (type) {
      case 'BOOL':
        return deserialize.boolean(value);
      case 'DATE':
        return deserialize.date(value);
      default:
        return value;
...
serializer.deserializeItem = function (item, schema) {
  ...
  var formatter = function (data) {
    ...
    return map(data, function(value, key) {
      ...
      if(_.isPlainObject(value)) {
        ...
        result = internals.deserializeAttribute(value, schema._modelDatatypes[key]);
      }
